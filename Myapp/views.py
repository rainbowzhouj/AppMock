...
def project_list(request):
    ...
    buttons=[{"name":"新增项目","href":"/add_project/","icon":"plus"},{"name":"项目数据","href":"javascript:project_data()","icon":"bars"}]
    db_project = DB_project.objects.all()  # 动态的 数据库中获取
    page_name="项目列表页"
    return render(request, 'project_list.html', {"project_list": db_project,"buttons":buttons,'page_name':page_name})
